myControllers.controller('analyticsCtrl', function ($scope, SymplAPIService,storage, $http) {
  ...
  SymplAPIService.getObjectCountByApp(storage.user.id).then(function (data) { //Other app with 0 value
    //Push sample app inside
    $scope.storage_model.objApp = data;
  });
  }

  {
    ...
    SymplAPIService.getTopObjectsByApp(storage.user.id,from,to).then(function(data){
      LoadTopObjects(data);
      self.storage_model.topObj = convertTopObjsGraphData(allTopObjectsApps[self.storage_app]);
    });
  }
  ...
  //  /*Call with country*/
  //  SymplAPIService.getAPICountAndTime(storage.user.id,id,true,from,to).then(function(data){
  //    loadAPIResponseAndTimeCountry(data);
  //  });
  //  SymplAPIService.getAPICountByDevice(storage.user.id,id,true,from,to).then(function(data){
  //    loadAPIDeviceCountry(data);
  //  });
  //  /*SymplAPIService.getViewHits(storage.user.id,id,true,from,to).then(function(data){
  //   loadViewHitsCountry(data);
  //   });*/
  //  SymplAPIService.getFileError(storage.user.id,id,true,from,to).then(function(data){
  //    loadFileErrorCountry(data);
  //  });
  //  SymplAPIService.getAPIError(storage.user.id,id,true,from,to).then(function(data){
  //    loadApiErrorCountry(data);
  //  });
  //
  //  /*Call W/o group by Country*/
  //  SymplAPIService.getAPICountAndTime(storage.user.id,id,false,from,to).then(function(data){
  //    loadAPIResponseAndTime(data);
  //    self.api_model.frequency_responseTime = convertApiTimeGraphData(allApiAndTimeInfo);
  //  });
  //  SymplAPIService.getAPICountByCountry(storage.user.id,id,from,to).then(function(data){
  //    loadAPICountry(data);
  //  });
  //  SymplAPIService.getAPICountByDevice(storage.user.id,id,false,from,to).then(function(data){
  //    loadAPIDevice(data);
  //
  //  });
  //  SymplAPIService.getViewHits(storage.user.id,id,false,from,to).then(function(data){
  //    loadViewHits(data);
  //    self.data_viewHits = convertViewHitsGraphData(allViewHitsData);
  //  });
  //
  //  SymplAPIService.getFileError(storage.user.id,id,false,from,to).then(function(data){
  //    loadFileError(data);
  //
  //  });
  //  SymplAPIService.getAPIError(storage.user.id,id,false,from,to).then(function(data){
  //    loadApiError(data);
  //  });
  //
  //}
  ...
  //  SymplAPIService.getAccStorageAndObj(storage.user.id,from,to).then(function(data){
